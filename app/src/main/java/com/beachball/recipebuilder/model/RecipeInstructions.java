...
/**
 * Created by Peter Emo on 28/06/2017.
 */
...
public class RecipeInstructions implements Parcelable {
    ...
    public static final Parcelable.Creator<RecipeInstructions> CREATOR
            = new Parcelable.Creator<RecipeInstructions>() {
        public RecipeInstructions createFromParcel(Parcel in) {
            return new RecipeInstructions(in);
        }

        public RecipeInstructions[] newArray(int size) {
            return new RecipeInstructions[size];
        }
    };

    private RecipeInstructions(Parcel in) {
        mData = in.readInt();
    }
}